...
if(isset($_POST['pass'])==1&&isset($_POST['Login'])==1){
if($_POST['Login']=='')
$_POST['Login']='"blah"';
if($_POST['pass']=='')
$_POST['pass']='"bleh"';
...
<div id="midd">
		...
		<form action="complaint.php" method="post">
			...
			<div class="inlnp" >
			<b>Subject:</b><br>
			<textarea name="sub" rows="2" cols="80" required></textarea>
			</div>
	...
	<?php 
		if(isset($_POST['nam']))
		{$sql="INSERT INTO Complaints(name,email,subject,_body) values('".$_POST['nam']."','".$_POST['mail']."','".$_POST['sub']."','".$_POST['body']."');";
				
		
				$result = $conn->query($sql);}
		if(isset($_POST['submit']))
			echo "<b>Your Complaint has been successfully Registered</b>";
	?>

...
<div id="midd">
	<h1>Access Denied</h1>
	<a href="hmpg.php"><div class="mitem" >
		<img src="imgres.jpg" class="ite" > </img> 
		<div class="lbl" href="hmpg.php"><h3 style="color:Black">Login Needed</h3><p style="color:Black">please Login to access this page</p></div>
	</div></a>

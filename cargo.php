...
<div id="midd">
	...
	<a href="flight_c.php"><div class="mitem" >
		<img src="fi.jpg" class="ite" > </img> 
		<div class="lbl" href="flight_c.php"><h3 style="color:Black">Flight Info</h3><p style="color:Black">Cargo flight information</p></div>
	</div></a>
	<a href="heavy_s.php"><div class="mitem" >
		<img src="hc.jpg" class="ite" > </img> 
		<div class="lbl" href="flight_c.php"><h3 style="color:Black">Heavy Shipments</h3><p style="color:Black">Heavy Load cargo </p></div>
	</div></a>
	<a href="time_c.php"<div class="mitem">
		<img src="ft.png" class="ite"> </img> 
		<div class="lbl"><h3 style="color:Black">Time table</h3><p style="color:Black">Derapture , arrivals </p></div>
	</a>
	<a href="contact_us.php"><div class="mitem">
		<img src="help.jpg" class="ite"> </img> 
		<div class="lbl"><h3 style="color:Black">Help</h3><p style="color:Black">contact customer service</p></div>
	</div></a>

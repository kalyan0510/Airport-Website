...
<div id="midd">
	...
	<a href="pilot.php"><div class="mitem" >
		<img src="pi.jpg" class="ite" > </img> 
		<div class="lbl" href="flight_p.php"><h3 style="color:Black">Pilot</h3><p style="color:Black">Details</p></div>
	</div></a>
	<a href="ah.php"><div class="mitem">
		<img src="ah.jpg" class="ite"> </img> 
		<div class="lbl"><h3 style="color:Black">Air Hostess</h3><p style="color:Black">Details</p></div>
	</div></a>
	<a href="ta.php"><div class="mitem">
		<img src="ta.jpg" class="ite"> </img> 
		<div class="lbl"><h3 style="color:Black">Ticketing Agent</h3><p style="color:Black">Details</p></div>
	</div></a>
	<a href="director.php"><div class="mitem">
		<img src="di.jpg" class="ite"> </img> 
		<div class="lbl"><h3 style="color:Black">Director</h3><p style="color:Black">Details</p></div>
	</div></a>
	<a href="security.php"><div class="mitem">
		<img src="se.jpg" class="ite"> </img> 
		<div class="lbl"><h3 style="color:Black">Security</h3><p style="color:Black">Details</p></div>
	</div></a>
